...
const sqliteSchemaPath = path.resolve(import.meta.dirname, 'schema.sqlite.prisma');
...
// ----------------------------------------------------\n\n`;
    ...
    console.log('[Database] SQLite schema generated and synchronized successfully.');
} catch (error) {
