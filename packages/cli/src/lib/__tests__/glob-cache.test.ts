...
describe("GlobCache", () => {
    ...
    it("trims entries beyond maxEntrySize to prevent unbounded memory growth", async () => {
        ...
        // Create more files than the default maxEntrySize cap (10000)
        // Use a modest overage to keep test fast
        const fileCount = 10005;
        ...
        // The cache should cap the results to maxEntrySize
        expect(files.length).toBeLessThanOrEqual(10000);
