...
describe('ImageHandler', () => {
    describe('isSupportedImage', () => {
        it('returns true for PNG files', () => {
            ...
            expect(imageHandler.isSupportedImage('/path/to/image.PNG')).toBe(
                true,
            );
        });
    ...
    describe('getDisplayName', () => {
        it('extracts basename from path', () => {
            expect(imageHandler.getDisplayName('/path/to/photo.png')).toBe(
                'photo.png',
            );
    ...
    describe('validateSize', () => {
        ...
        it('rejects data URLs over 10MB', () => {
            // ~12MB base64 string
            const largeDataUrl =
                'data:image/png;base64,' + 'a'.repeat(16_000_000);
