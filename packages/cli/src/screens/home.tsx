    ...
    const handleSubmit = useCallback(
        (text: string) => {
            navigate('/sessions/new', {
                state: { message: text, mode, model, imageAttachments },
            });
        },
                ...
                {savedSession ? (
                    <box flexDirection="column" gap={0} marginBottom={1}>
                        <text>
                            ...
                            <em fg={colors.primary}>
                                {savedSession.title || 'Untitled'}
                            </em>
                        </text>
                        <text attributes={TextAttributes.DIM}>
                            Press ctrl+y to resume, or start a new conversation
                            below
                        </text>
                    </box>
                ) : null}
