...
describe('toolInputSchemas', () => {
    describe('readFile', () => {
        it('parses valid input', () => {
            const result = toolInputSchemas.readFile.parse({
                path: 'src/index.ts',
            });
    ...
    describe('spawnAgent', () => {
        ...
        it('parses with optional model', () => {
            ...
            expect(result.model).toBe('nvidia/deepseek-ai/deepseek-v4-flash');
        });
    });
...
describe('getSubagentToolContracts', () => {
    it('includes spawnAgent for subagents', () => {
        ...
        expect((planTools as Record<string, unknown>).spawnAgent).toBeDefined();
    });
